<?php
 ...
 #$_GET['is_paid'] = 'yes';  
 $field = array("name","address","contact","amount","ptype");
 $_GET['ptype'] = 'withdraw';
...
$filter = "SELECT b.name,b.address,b.custom_label,a.*,MONTH(actual) as month,WEEK(actual) as week,YEAR(actual) as year,DAY(actual) as day FROM tbl_passbook as a LEFT JOIN tbl_members as b ON a.user=b.id";

}else{

$filter = "SELECT b.name,b.address,b.custom_label,a.*,MONTH(actual) as month,WEEK(actual) as week,YEAR(actual) as year,DAY(actual) as day,SUM(amount) as total FROM tbl_passbook as a LEFT JOIN tbl_members as b ON a.user=b.id";
